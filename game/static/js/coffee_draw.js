...
(function() {
  var Countdown, User, Users, battle, dude, enemy, myTurn, ready, socket, war;
    ...
    socket.on("ready", function(data) {
      if (username !== data) {
        ...
        if (ready === 2) {
          ...
          return $('#notificationSmall').html("Start battle!").dequeue().stop().slideDown(200).delay(1700).slideUp(200);
        } else {
