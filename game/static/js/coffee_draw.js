...
(function() {
  var User, Users, battle, dude, enemy, myTurn, socket, war;
  ...
  $(document).ready(function() {
          ...
          if (data === 'hit') {
            ...
            if (data === 'finished') {
              return $.post('/battle/', {
                ...
                $('#notification').html("You lost").dequeue().stop().slideDown(200).delay(1700).slideUp(200, function() {
    ...
    socket.on("win", function() {
      ...
      $('#notification').html("You won").dequeue().stop().slideDown(200).delay(1700).slideUp(200, function() {
        return window.location = '/';
      });
      return myTurn = false;
    });
