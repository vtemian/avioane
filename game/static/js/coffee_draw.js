...
(function() {
  var Countdown, User, Users, battle, checked, dude, enemy, move_timer, myTurn, ready, socket, timer, war;
  ...
  $(document).ready(function() {
        ...
        return setTimeout(function() {
          return $('#versus').fadeOut('slow', function() {
            ...
            $.get('/hangar/get-wepons/', function(data) {
              obj = $.parseJSON(data);
              return $.each(obj.weapons, function(index, item) {
    ...
    $('li[data-type=shield]').live("click", function() {
      if (checked) {
        if (myTurn) {
          $('#notificationBig').attr('class', 'alert notification');
          return $('#notificationBig').html("The future is near...").dequeue().stop().slideDown(200).delay(1700).slideUp(200);
        } else {
          $('#notificationBig').attr('class', 'alert notification');
