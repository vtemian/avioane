...
print "[+] User :",user
print "[+] BruteForcing...\n"
for a1 in range(33, 122):
	for a2 in range(33, 122):
		for a3 in range(33, 122):
			for a4 in range(33, 122):
				for a5 in range(33, 122):
					for a6 in range(33, 122):
						for a7 in range(33, 122):
							for a8 in range(33, 122):
								print chr(a1)+chr(a2)+chr(a3)+chr(a4)+chr(a5)+chr(a6)+chr(a7)+chr(a8)
