# Django settings for avioane project.
import os
...
DATABASES = {
    'default': {
        ...
        'NAME': 'avioane',                      # Or path to database file if using sqlite3.
        'USER': 'avioane',                      # Not used with sqlite3.
        'PASSWORD': 'avioane',                  # Not used with sqlite3.
...
STATIC_ROOT = '/home/avioanestatic'
...
SECRET_KEY = '@d15wzhd0x04z6s_dm8wadm71uz09--1i6^y+8hf6%5c28x$x('
